...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 05, 2023 at 03:37 PM
...
--
ALTER TABLE `teknisi`
  ADD CONSTRAINT `teknisi_ibfk_1` FOREIGN KEY (`kode_aset`) REFERENCES `aset` (`kode_aset`) ON DELETE CASCADE ON UPDATE CASCADE,
